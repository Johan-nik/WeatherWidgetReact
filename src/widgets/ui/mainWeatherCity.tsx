...
import { getWeatherWidget } from "../utils/getWeatherWidget";
import { CarouselProvider, Slider, Slide, ButtonBack, ButtonNext, Dot } from "pure-react-carousel";
import "pure-react-carousel/dist/react-carousel.es.css";
import s from "../../shared/assets/styles/Carousel.module.css";
        ...
        >
            <Slider>
                {cityData.map((city, index) => {
                    const WeatherWidget = getWeatherWidget(city.weatherCode, city.timeZoneOffset);
                ...
                <ButtonNext className={`${s.carouselButtonScroll} ${s.buttonRigth}`}>
                    <div className={s.widgetConteiner__buttonScroll}>
                        <svg
                            width="24"
                            height="24"
